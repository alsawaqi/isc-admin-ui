...
import { definePageMeta, useNuxtApp, reactive,watch } from '#imports'
...
const fetchOrders = async () => {
  try {
    const { data }  = await $axios.get('/api/orders-placed/packing', {
      params: {
        page: table.page,
        ...
        <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
          <div class="d-flex flex-wrap align-items-center gap-3">
            ...
            <div class="icon-field">
              <input type="text" name="#0" class="form-control form-control-sm w-auto" placeholder="Search"  v-model="table.search" />
              <span class="icon">
                ...
                <tr v-for="(order, index) in orders" :key="order.id">
                  ...
                  <td class="py-2 px-3">
                    <div class="d-flex justify-content-center gap-2">
                      <NuxtLink :to="`/admin/orders/packing/${order.id}`" class="btn btn-sm btn-success px-3">View
                      </NuxtLink>
