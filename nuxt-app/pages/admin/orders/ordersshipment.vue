...
const fetchOrders = async () => {
  try {
    const { data } = await $axios.get('/api/orders-placed/shipment', {
      params: {
        page: table.page,
...
<template>
  ...
  <div class="dashboard-main-body">
       ...
       <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
              <h6 class="fw-semibold mb-0" style="color: #ef4444">View Shippments</h6>
              <ul class="d-flex align-items-center gap-2">
                  ...
                  <li>-</li>
                  <li class="fw-medium">View Shippments</li>
              </ul>
          </div>
                ...
                <tr v-for="(order, index) in orders" :key="order.id">
                  ...
                  <td class="py-2 px-3">
                    <div class="d-flex justify-content-center gap-2">
                      <NuxtLink :to="`/admin/orders/shippment/${order.id}`" class="btn btn-sm btn-success px-3">View</NuxtLink>
