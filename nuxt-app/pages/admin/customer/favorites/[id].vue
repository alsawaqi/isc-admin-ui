...
const fetchFavorites = async (): Promise<void> => {
    loading.value = true;
    try {
        const { data } = await $axios.get(`/api/customers/favorites`, {
            params: {
        ...
        Favorites.value = paginator.data;
    ...
    <div class="dashboard-main-body">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0" style="color: #ef4444">
                ...
                View {{ customer?.Customer_Full_Name }} {{ Favorites.length > 0 ? ' (' + Favorites.length + ')' : '' }}
                Favoritess
            </h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">View {{ customer?.Customer_Full_Name }} Favorites</li>
            </ul>
        </div>
                        ...
                        <table class="table table-hover table-striped align-middle mb-0 table-sticky">
                            ...
                            <tbody v-else>
                                <tr v-for="(favorite, index) in Favorites" :key="favorite.id">
                                    ...
                                    <td class="py-3 px-3">
                                        {{ favorite.product?.Product_Price }} OMR
                                    </td>
