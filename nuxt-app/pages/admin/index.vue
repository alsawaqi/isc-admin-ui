                        ...
                        <table class="table bordered-table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="/public/isc-assets/images/users/user1.png" alt="" class="flex-shrink-0 me-12 radius-8">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="/public/isc-assets/images/users/user2.png" alt="" class="flex-shrink-0 me-12 radius-8">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="/public/isc-assets/images/users/user3.png" alt="" class="flex-shrink-0 me-12 radius-8">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="/public/isc-assets/images/users/user4.png" alt="" class="flex-shrink-0 me-12 radius-8">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="/public/isc-assets/images/users/user5.png" alt="" class="flex-shrink-0 me-12 radius-8">
                    ...
                    <div class="mt-32">
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                            <div class="d-flex align-items-center gap-2">
                                <img src="/public/isc-assets/images/payment/payment1.png" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                            <div class="d-flex align-items-center gap-2">
                                <img src="/public/isc-assets/images/payment/payment2.png" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                            <div class="d-flex align-items-center gap-2">
                                <img src="/public/isc-assets/images/payment/payment3.png" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                            <div class="d-flex align-items-center gap-2">
                                <img src="/public/isc-assets/images/payment/payment4.png" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                                <div class="flex-grow-1">
                    ...
                    <div class="">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-12 pb-2">
                            <div class="d-flex align-items-center w-100">
                                <img src="/public/isc-assets/images/flags/flag1.png" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12">
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-12 pb-2">
                            <div class="d-flex align-items-center w-100">
                                <img src="/public/isc-assets/images/flags/flag2.png" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12">
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-12 pb-2">
                            <div class="d-flex align-items-center w-100">
                                <img src="/public/isc-assets/images/flags/flag3.png" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12">
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3">
                            <div class="d-flex align-items-center w-100">
                                <img src="/public/isc-assets/images/flags/flag4.png" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12">
                                <div class="flex-grow-1">
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-32">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                            <div class="d-flex align-items-center gap-2">
                                <img src="/public/isc-assets/images/users/user6.png" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                            <div class="d-flex align-items-center gap-2">
                                <img src="/public/isc-assets/images/users/user1.png" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                            <div class="d-flex align-items-center gap-2">
                                <img src="/public/isc-assets/images/users/user2.png" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                            <div class="d-flex align-items-center gap-2">
                                <img src="/public/isc-assets/images/users/user3.png" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                            <div class="d-flex align-items-center gap-2">
                                <img src="/public/isc-assets/images/users/user4.png" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                                <div class="flex-grow-1">
                        ...
                        <table class="table bordered-table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="/public/isc-assets/images/product/product-img1.png" alt="" class="flex-shrink-0 me-12 radius-8 me-12">
                                            <div class="flex-grow-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="/public/isc-assets/images/product/product-img2.png" alt="" class="flex-shrink-0 me-12 radius-8 me-12">
                                            <div class="flex-grow-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="/public/isc-assets/images/product/product-img3.png" alt="" class="flex-shrink-0 me-12 radius-8 me-12">
                                            <div class="flex-grow-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="/public/isc-assets/images/product/product-img4.png" alt="" class="flex-shrink-0 me-12 radius-8 me-12">
                                            <div class="flex-grow-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="/public/isc-assets/images/product/product-img5.png" alt="" class="flex-shrink-0 me-12 radius-8 me-12">
                                            <div class="flex-grow-1">
