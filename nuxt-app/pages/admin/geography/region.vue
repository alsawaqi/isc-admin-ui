                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="mb-20">
                                ...
                                <input type="text" class="form-control radius-8 w-full" v-model="Region_Name"
                            ...
                            <div class="mb-20">
                                ...
                                <input type="text" class="form-control radius-8 w-full" v-model="Region_Name_Ar"
                                    placeholder="اسم المنطقة" dir="auto" />
                            </div>
                ...
                <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <div class="icon-field">
                            <input v-model="table.search" type="text" name="#0"
                            ...
                            <tr v-for="state in regions" :key="state.id">
                                ...
                                <td class="text-end">
                                    <a href="javascript:void(0)"
                                        ...
                                        title="Edit" @click="openEdit(state)">
                                    ...
                                    <a href="javascript:void(0)"
                                        ...
                                        title="Delete" @click="deleteRegion(state.id)">
            ...
            <div class="bg-white radius-12 shadow p-24"
                ...
                <div>
                    ...
                    <div class="mb-16">
                        ...
                        <select v-model="edit_Country_Id" class="form-control radius-8 w-full">
                            <option value="">-- Select Country --</option>
                            <option v-for="country in countries" :key="country.id" :value="country.id">
                                {{ country.Country_Name }}
                            </option>
                    ...
                    <div class="mb-16">
                        ...
                        <input type="text" class="form-control radius-8 w-full" v-model="edit_Region_Name"
                            placeholder="Region Name (English)" />
                    </div>
                    ...
                    <div class="mb-16">
                        ...
                        <input type="text" class="form-control radius-8 w-full" v-model="edit_Region_Name_Ar"
                            placeholder="اسم المنطقة" dir="auto" />
                    </div>
